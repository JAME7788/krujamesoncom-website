...
const levels: Level[] = [
  ...
  },
  {
    ...
    maxBlocks: 20,
    hint: 'ไปทางขวาเก็บ ⭐ ด้านบน แล้วเดินย้อนกลับมาลงทางซ้ายเพื่อไปหาเป้าหมาย',
  },
  {
    name: 'ซิกแซก',
    ...parseGrid([
  ...
  },
  {
    ...
    maxBlocks: 18,
    hint: 'ทางด้านบนมีผนังกั้น ลองลงไปใช้ทางยาวด้านล่างแล้วค่อยขึ้นหา G',
  },
  {
    name: 'สามดาวสามมุม',
    ...parseGrid([
    ...
    maxBlocks: 30,
    hint: 'เก็บดาวบนก่อน ลงช่องซ้ายหาอีกดวง แล้วใช้ทางล่างอ้อมไปยังเป้าหมาย',
  },
  {
    name: 'ทางลวงสองด้าน',
    ...parseGrid([
    ...
    maxBlocks: 20,
    hint: 'ทางซ้ายล่างเป็นทางตัน ให้เดินตามขอบด้านบนแล้วลงทางขวา',
  },
  {
    ...
    maxBlocks: 35,
    hint: 'ลงไปเก็บดาวทั้งสามตามแถวล่าง แล้วขึ้นทางขวาไปหา G',
  },
  {
    name: 'ภารกิจรอบกำแพง',
    ...parseGrid([
