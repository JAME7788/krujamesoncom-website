...
<body>
  ...
  <div class="score-note"><strong>โครงสร้างคะแนน:</strong> คะแนนเก็บตามตัวชี้วัด 70 คะแนน + สอบปลายภาคของเทอม 30 คะแนน = 100 คะแนน (ประถมไม่มีช่องสอบกลางภาคในสมุดคะแนน)</div>
</body>
</html>`;
};
  ...
  return (
    <div className="techschedule-shell">
      ...
      <section className="techschedule-score-note">
        <strong>การวัดและประเมินผลประถม 100 คะแนน</strong>
        <span>คะแนนเก็บตามตัวชี้วัด 70 คะแนน</span>
        <span>สอบปลายภาคของเทอม 30 คะแนน</span>
        <p>ประถมศึกษาไม่มีช่องสอบกลางภาคในสมุดคะแนน โดยหลักฐานรายคาบส่งต่อการเก็บคะแนน K/P/A ตามตัวชี้วัดในสมุดคะแนนของเว็บ</p>
      </section>
    </div>
  );
};
