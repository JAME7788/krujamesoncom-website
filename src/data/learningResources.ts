...
const officialResources: LearningResource[] = [
  {
    ...
    title: 'ครูประภาส: ชุดบทเรียน Arduino',
    desc: 'หน้ารวมบทความและเอกสาร Arduino สำหรับสร้างรายวิชาไมโครคอนโทรลเลอร์ ตั้งแต่พื้นฐานจนถึงใบงานทดลอง',
  ...
  {
    id: 'official-myipst',
    title: 'My IPST คลังสื่อ สสวท.',
    desc: 'ค้นคู่มือครู แผนการจัดการเรียนรู้ ไฟล์นำเสนอ วีดิทัศน์ แบบทดสอบ และใบกิจกรรมตามระดับชั้น',
    url: 'https://myipst.ipst.ac.th/baskets/search',
    emoji: '📚',
    category: 'computational',
    badge: 'แหล่งทางการ',
    targetUnits: [],
  ...
  },
  {
    ...
    desc: 'วิดีโอบทเรียนออนไลน์ตามมาตรฐาน ตัวชี้วัด และหนังสือเรียน สสวท. ใช้ทบทวนก่อนหรือหลังเรียน',
  ...
  {
    id: 'official-dltv',
    title: 'DLTV แผนการสอนและใบงาน',
    desc: 'แผนรายชั่วโมง คู่มือครู ใบงาน ใบกิจกรรม และแบบประเมินสำหรับเสริมการสอนในห้องเรียน',
    url: 'https://dltv.ac.th/teachplan/lists/1/36000',
    emoji: '📝',
    category: 'computational',
    badge: 'แหล่งทางการ',
    targetUnits: [],
  ...
  {
    id: 'official-dltv-p1-guide-pdf',
    title: 'DLTV คู่มือครูและแผนการสอน ป.1 PDF',
    desc: 'ไฟล์คู่มือครูและแผนการจัดการเรียนรู้ เทคโนโลยี ป.1 ภาคเรียนที่ 1-2568 พร้อมสารบัญหน่วยและแบบประเมิน',
  ...
  // ===== Project 14 สสวท. ต่อระดับชั้น =====
  {
    ...
    desc: 'หนังสือเรียน คลิปวิดีโอ และคู่มือครูตามตัวชี้วัด ว 4.2 ป.1 — ทบทวนได้ทุกหน่วย',
  ...
  // ===== DLTV แผนรายชั่วโมง ต่อระดับชั้น =====
  {
    id: 'dltv-p1',
    title: 'DLTV เทคโนโลยี ป.1 — แผนรายชั่วโมง',
    desc: 'แผนการสอนรายชั่วโมง + ใบงาน + วิดีโอครูสอน เทคโนโลยี ป.1 (DLTV ครบทุกชั่วโมง)',
    url: 'https://www.dltv.ac.th/teachplan/episode/40293',
    emoji: '📺',
    category: 'computational',
    badge: 'DLTV',
    targetUnits: [
  ...
  {
    id: 'dltv-p2',
    title: 'DLTV เทคโนโลยี ป.2 — แผนรายชั่วโมง',
    desc: 'แผนรายชั่วโมง ใบงาน คลิปครูสอน',
    url: 'https://www.dltv.ac.th/teachplan/episode/40563',
    emoji: '📺',
    category: 'computational',
    badge: 'DLTV',
    targetUnits: [
  ...
  {
    id: 'dltv-p3',
    title: 'DLTV เทคโนโลยี ป.3 — แผนรายชั่วโมง',
    desc: 'แผนรายชั่วโมง ใบงาน คลิปครูสอน',
    url: 'https://www.dltv.ac.th/teachplan/episode/40823',
    emoji: '📺',
    category: 'computational',
    badge: 'DLTV',
    targetUnits: [
  ...
  {
    id: 'dltv-p4',
    title: 'DLTV วิทยาการคำนวณ ป.4 — แผนรายชั่วโมง',
    desc: 'แผนรายชั่วโมง ใบงาน คลิปครูสอน',
    url: 'https://www.dltv.ac.th/teachplan/episode/41093',
    emoji: '📺',
    category: 'computational',
    badge: 'DLTV',
    targetUnits: [
  ...
  {
    id: 'dltv-p5',
    title: 'DLTV วิทยาการคำนวณ ป.5 — แผนรายชั่วโมง',
    desc: 'แผนรายชั่วโมง ใบงาน คลิปครูสอน',
    url: 'https://www.dltv.ac.th/teachplan/episode/41353',
    emoji: '📺',
    category: 'computational',
    badge: 'DLTV',
    targetUnits: [
  ...
  {
    id: 'dltv-p6',
    title: 'DLTV วิทยาการคำนวณ ป.6 — แผนรายชั่วโมง',
    desc: 'แผนรายชั่วโมง ใบงาน คลิปครูสอน',
    url: 'https://www.dltv.ac.th/teachplan/episode/41613',
    emoji: '📺',
    category: 'computational',
    badge: 'DLTV',
    targetUnits: [
  ...
  {
    id: 'dltv-m1',
    title: 'DLTV วิทยาการคำนวณ ม.1 — แผนรายชั่วโมง',
    desc: 'แผน + คลิปสอน ม.1 ทั้ง 2 ภาคเรียน',
    url: 'https://www.dltv.ac.th/teachplan/episode/41873',
    emoji: '📺',
    category: 'programming',
    badge: 'DLTV',
    targetUnits: [{ gradeId: 'm1-cs', unitNo: 1 }, { gradeId: 'm1-cs', unitNo: 2 }],
  ...
  {
    id: 'dltv-m2',
    title: 'DLTV วิทยาการคำนวณ ม.2 — แผนรายชั่วโมง',
    desc: 'แผน + คลิปสอน ม.2',
    url: 'https://www.dltv.ac.th/teachplan/episode/42143',
    emoji: '📺',
    category: 'programming',
    badge: 'DLTV',
    targetUnits: [
  ...
  {
    id: 'dltv-m3',
    title: 'DLTV วิทยาการคำนวณ ม.3 — แผนรายชั่วโมง',
    desc: 'แผน + คลิปสอน ม.3',
    url: 'https://www.dltv.ac.th/teachplan/episode/42413',
    emoji: '📺',
    category: 'programming',
    badge: 'DLTV',
    targetUnits: [
