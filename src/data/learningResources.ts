...
const programmingResources: LearningResource[] = [
  ...
  },
  {
    ...
    url: 'https://studio.code.org/s/starwarsblocks',
    emoji: '⭐',
    category: 'programming',
    badge: 'Hour of Code',
    targetUnits: [
  ...
  },
  {
    ...
    url: 'https://studio.code.org/s/artist',
    emoji: '🎨',
    category: 'programming',
    badge: 'Hour of Code',
    targetUnits: [
  ...
  },
  {
    ...
    url: 'https://studio.code.org/s/playlab',
    emoji: '🎮',
    category: 'programming',
    badge: 'Hour of Code',
    targetUnits: [
...
const officialResources: LearningResource[] = [
  ...
  // ===== Project 14 สสวท. ต่อระดับชั้น =====
  {
    ...
    url: 'https://proj14.ipst.ac.th/p1/',
    emoji: '🎬',
    category: 'computational',
    badge: 'สสวท.',
    targetUnits: [
  ...
  },
  {
    ...
    url: 'https://proj14.ipst.ac.th/p2/',
    emoji: '🎬',
    category: 'computational',
    badge: 'สสวท.',
    targetUnits: [
  ...
  },
  {
    ...
    url: 'https://proj14.ipst.ac.th/p3/',
    emoji: '🎬',
    category: 'computational',
    badge: 'สสวท.',
    targetUnits: [
  ...
  },
  {
    ...
    url: 'https://proj14.ipst.ac.th/m1/',
    emoji: '🛠️',
    category: 'design',
    badge: 'สสวท.',
    targetUnits: [
  ...
  },
  {
    ...
    url: 'https://proj14.ipst.ac.th/m2/',
    emoji: '🛠️',
    category: 'design',
    badge: 'สสวท.',
    targetUnits: [
  ...
  },
  {
    ...
    url: 'https://proj14.ipst.ac.th/m3/',
    emoji: '🛠️',
    category: 'design',
    badge: 'สสวท.',
    targetUnits: [
