...
export const buildOfficialLessonNotes = (grade: Grade, unit: Unit): LessonNotes => {
  ...
  return {
    objectives: [
      `ศึกษาและทบทวนเนื้อหาเรื่อง "${unit.title}" ผ่านสื่อและกิจกรรมตัวอย่าง`,
      'ลงมือฝึกปฏิบัติและตรวจสอบความเข้าใจจากกิจกรรมท้ายบท',
    ],
    summary: [
      `สามารถทบทวนเนื้อหาเพิ่มเติมได้จากแหล่งเรียนรู้ชั้นนำ เช่น ${sourceLabel}`,
      'ฝึกคิดวิเคราะห์ แก้ปัญหาอย่างเป็นลำดับขั้นตอน และนำความรู้ไปประยุกต์ใช้จริง',
    ],
    activities: [
      `เปิดคลิปวิดีโอหรือสื่อการสอนแนะนำเรื่อง "${unit.title}" แล้วบันทึกข้อคิดสำคัญ 2-3 ข้อ`,
      themeActivity,
      'ฝึกทำใบกิจกรรมหรือแบบฝึกหัดแล้วสรุปสิ่งที่เข้าใจกับเพื่อนร่วมชั้น',
    ],
    checkQuestions: [
      `ความรู้จากเรื่อง "${unit.title}" สามารถนำไปประยุกต์ใช้ในสถานการณ์ใดได้บ้าง`,
      'ขั้นตอนใดในบทเรียนนี้ที่ท้าทายที่สุด และนักเรียนมีวิธีทำความเข้าใจอย่างไร',
    ],
    vocabulary: [
      'สื่อการเรียนรู้: แหล่งข้อมูล วิดีโอ หรือแบบฝึกหัดที่ช่วยให้เข้าใจเนื้อหาดียิ่งขึ้น',
      'การประยุกต์ใช้: การนำความรู้และหลักการไปแก้ปัญหาในสถานการณ์จริง',
    ],
  };
};
